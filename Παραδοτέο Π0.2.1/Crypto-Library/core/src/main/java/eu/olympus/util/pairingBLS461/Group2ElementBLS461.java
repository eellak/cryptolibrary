...
public class Group2ElementBLS461 implements Group2Element {
    ...
    public Group2ElementBLS461(ECP2 x){
        ...
        this.x=x;//Copy?
        System.out.println("Hereeeeeee!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!, Take Group!!!!");
        long endTime = System.currentTimeMillis(); // Record end time
        double elapsedTime = (endTime - startTime) / 1000.0; // Calculate elapsed time in seconds

        System.out.println("Elapsed time for Group2ElementBLS461 constructor: " + elapsedTime + " seconds");
    ...
    private static ECP2 transformFromProto(PabcSerializer.ECP2 w) {
        ...
        FP valuexa_fp = new FP(BIG.fromBytes(valuexa));
        FP valuexb_fp = new FP(BIG.fromBytes(valuexb));
        FP2 valuex = new FP2(valuexa_fp, valuexb_fp);

        FP valueya_fp = new FP(BIG.fromBytes(valueya));
        FP valueyb_fp = new FP(BIG.fromBytes(valueyb));
        FP2 valuey = new FP2(valueya_fp, valueyb_fp);
