...
public class OidcConfiguration {
    ...
    public UserClient createUserClient() {
        ...
        List<CombinedIdPRESTConnection> idps = new ArrayList<CombinedIdPRESTConnection>();
        ...
        for (int i = 0; i < serverArray.length; i++) {
            ...
            CombinedIdPRESTConnection idp = new CombinedIdPRESTConnection(serverArray[i], "", i, 100000);
            idps.add(idp);
        }
...
//        applicationcategory for policy because openid
        predicates.add(new Predicate("family_name", Operation.REVEAL, null));
