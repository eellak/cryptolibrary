            ...
            <div style={styles.root}>
                <div style={styles.title}>
                    ...
                    <div align="center">
                        ...
                        <h4 style={{color: "grey"}}>Awarded Degree: {user ? user.profile.family_name : "University"}</h4>
                ...
                <Container style={styles.buttonBox}>
                    <Typography variant="subtitle1" align="center">
                        ...
                        <Button
                            ...
                            setTimeout(() => window.open("http://localhost:10000/continue/msc", "_blank"), 1000);
                        }}
                        >
...
export default connect(mapStateToProps)(storage1);
